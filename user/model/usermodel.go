...
type (
	User struct {
		...
		Mobile string  `xorm:"varchar(20) notnull unique 'mobile'"`
		Password string  `xorm:"varchar(20) notnull 'password'"`
...
func (m *UserModel) ExistMobile(mobile string) (bool, error)  {
